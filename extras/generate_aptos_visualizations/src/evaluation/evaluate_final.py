...
from src.evaluation.gradcam import GradCAMHooker, apply_heatmap, generate_masked_gradcam
...
class FinalInferencer:
    ...
    """
    def __init__(self, model_paths, target_resolution=768, temperature=1.5, use_tta=True):
        ...
        self.ensemble = SoftVotingEnsemble(models, use_tta=use_tta)
