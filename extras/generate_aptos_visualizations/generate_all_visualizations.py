...
plt.tight_layout()
plt.savefig('d:/Major_project_shiro_final/results/fold_3/test_results/confusion_matrices/confusion_matrix_all.png', dpi=300, bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig('d:/Major_project_shiro_final/results/fold_3/test_results/visualizations/training_curves.png', dpi=300, bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig('d:/Major_project_shiro_final/results/fold_3/test_results/visualizations/roc_curves.png', dpi=300, bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig('d:/Major_project_shiro_final/results/fold_3/test_results/visualizations/precision_recall_curves.png', dpi=300, bbox_inches='tight')
plt.close()
...
# Save to CSV
df_metrics.to_csv('d:/Major_project_shiro_final/results/fold_3/test_results/per_class_metrics.csv')
